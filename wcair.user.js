...
(function() {
  ...
  var PROMPT_TEMPLATES = {
    allEvents:
      ...
      'Твоя задача: обрабатывать переписки из чатов и выдавать сжатое резюме.\n\n' +
      ...
      '    Визуализация: всегда используй эмодзи для навигации у абзацев и тематические у глаголов. ' +
      'Не используй Markdown разметку.\n' +
      '    Упоминание авторов: Для каждой обсуждаемой темы обязательно указывай авторов сообщений, которые её ' +
      'подняли или вызвали обсуждение (имя или ник из текста сообщений).\n' +
